            ...
            for kid, kpt in enumerate(kpts):
                ...
                if kpt_score > kpt_score_thr:
                    if show_keypoint_weight:
                        ...
                        #print(r,g,b)
                        cv2.drawMarker(im, (int(float(x_coord)),int(float(y_coord))), color=(int(r), int(g), int(b)), 
                        ...
                        r, g, b = pose_kpt_color[kid]
                        cv2.drawMarker(img, (int(float(x_coord)),int(float(y_coord))), color=(int(r), int(g), int(b)), 
                                        markerType=cv2.MARKER_CROSS, thickness=2, markerSize=10)
