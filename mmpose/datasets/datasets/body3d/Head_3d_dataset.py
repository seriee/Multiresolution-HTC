...
class Head3dDataset(Kpt3dSviewKpt2dDataset):
    ...
    JOINT_NAMES = [
        'Menton', 'Gnathion', 'Pogonion', 'B point', 'lower lip', 'Infradentale',
        'lower incisal_incision', 'upper incisal_incision', 'upper lip', 'Subnasale', 'ANS', 'PNS', 'Orbitale(left)',
        'Orbitale(right)', 'Nasion', 'Bregma'
    ]
